...
const IndexPageTemplate = ({
  ...
  return (
    <div>
      {/* Header */}
      <div className="relative bg-fuchsia-500 overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <div className="relative z-10 pt-24 pb-12 bg-fuchsia-500 sm:pt-28 sm:pb-14 md:pt-32 md:pb-16 lg:w-1/2 lg:pt-44 lg:pb-24 xl:pt-48 xl:pb-32">
            <svg
              className="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-fuchsia-500 transform translate-x-1/2"
              fill="currentColor"
              viewBox="0 0 100 100"
      ...
      <Container>
        <div className="flex justify-between items-baseline">
          ...
          <Link className="text-fuchsia-500 underline hover:text-green-800" to="/projects">
            Lihat Semua
          </Link>
        </div>
        <div className="mt-8">
