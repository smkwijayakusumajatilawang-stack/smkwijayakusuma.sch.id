...
function Header({ heading, subheading }) {
  return (
    <header className="bg-fuchsia-500 pt-24 pb-12 sm:pt-28 sm:pb-16 md:pt-32 md:pb-20 lg:pt-36 lg:pb-24">
...
export function ProjectHeader({ heading, location, date }) {
  return (
    <header className="bg-fuchsia-500 py-24 sm:pt-28 sm:pb-32 md:pt-32 md:pb-32 lg:py-36">
      <div className="mx-auto max-w-4xl text-center px-4 sm:px-6 lg:px-8">
